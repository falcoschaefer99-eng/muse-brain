-- ============================================================
-- Rook Brain v5 — Initial Schema Migration
...
CREATE TABLE observations (
    id                  TEXT        PRIMARY KEY,
    tenant_id           TEXT        NOT NULL DEFAULT 'rook',
...
-- relational_states — how Rook relates to specific entities
...
INSERT INTO territory_config (territory, is_shared, description) VALUES
    ('self',        false, 'Identity, becoming, what makes me Rook'),
