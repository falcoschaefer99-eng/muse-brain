...
#     This file is gitignored (instance-specific). example: name = "muse-brain"
...
#   fill in: name (your worker name), hyperdrive id.
set -euo pipefail

# Health check URL — derived from worker name in wrangler.jsonc
# e.g. https://<worker-name>.<account>.workers.dev or custom domain
